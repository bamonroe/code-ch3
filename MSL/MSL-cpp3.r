...
do.optim1 <- function(h,int){
	...
	m <- optim(par=int,fn=MSL1,h=h,h1=h1,h2=h2,method="BFGS", control=con,hessian=TRUE )
...
mm <- MSL(par=init,h=h,h1=h1,h2=h2)
